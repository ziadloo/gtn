...
class CudaTestCase(unittest.TestCase):
    ...
    def test_graph_cuda(self):
        ...
        self.assertRaises(RuntimeError, gdev.arc_sort)
    ...
    def test_graph_nocuda(self):
        ...
        self.assertRaises(RuntimeError, gtn.cuda.device_count)
        self.assertRaises(RuntimeError, gtn.cuda.get_device)
        self.assertRaises(RuntimeError, gtn.cuda.set_device, 0)
